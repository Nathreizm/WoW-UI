...
L["doubleSize"] = "2배 크기"
L["doubleSizeDesc"] = "특수 강조 바와 메시지의 크기를 2배로 합니다."
L["emphasize"] = "강조"
L["emphasizeAt"] = "강조... (초)"
L["emphasized"] = "강조"
...
L["fontColor"] = "글꼴 색상"
L["fontSize"] = "글꼴 크기"
L["growUpwards"] = "윗쪽으로 쌓기"
L["growUpwardsDesc"] = "바의 생성 방향을 위/아래로 전환합니다."
L["icon"] = "아이콘"
...
L["soundDefaultDescription"] = "이 옵션을 켜면, Big Wigs는 음향 경고가 같이 나오는 메시지에 대해서 기본 블리자드 공격대 경보 음을 사용합니다. 오직 보스 스크립트들 중에서 몇몇 메시지들만이 소리 경고를 작동시킵니다."
L["soundDelay"] = "효과음 지연"
...
L["wrongPullFormat"] = "1에서 60 사이의 숫자여야 합니다. 예: /pull 5"
