...
L["growUpwardsDesc"] = "Переключение направления роста полос вверх или вниз."
L["icon"] = "Иконка"
...
L["sendCustomBar"] = "Отправка таймера '%s' пользователям Big Wigs и DBM."
L["sendPull"] = "Отправка таймера атаки пользователям Big Wigs и DBM."
...
L["timerFinished"] = "%s: Таймер [%s] готов."
L["title"] = "Название"
...
L["wrongPullFormat"] = "Должно быть между 1 и 60. Например: /pull 5"
