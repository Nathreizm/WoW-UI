...
|cFF00CC00>= 0|r 無論何時總是觸發]=] -- Needs review
...
L["Icon Info"] = "圖示訊息"
L["Icon Inset"] = "圖示內嵌" -- Needs review
L["Ignored"] = "忽略"
...
L["Search"] = "搜尋"
L["Secondary"] = "第二天賦"
L["Select the auras you always want to be listed first"] = "選擇要列在前面的特效" -- Needs review
L["Send To"] = "發送到"
...
L["Texture"] = "材質"
L["Texture Info"] = "材質資料" -- Needs review
