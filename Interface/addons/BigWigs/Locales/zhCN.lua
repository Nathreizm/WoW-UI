...
L["advanced"] = "高级选项"
L["allRightsReserved"] = "保留所有权利"
L["alphaOutdated"] = "Big Wigs α 测试版已过期。（/bwv）。"
L["alphaRelease"] = "你所使用的 Big Wigs %s 为“α测试版”（修订号%d）"
...
L["blockMovies"] = "阻止首领过场动画"
L["blockMoviesDesc"] = "在看过一次首领过场动画以后，Big Wigs 将防止它再次播放。"
L["bosskill"] = "首领死亡"
...
L["extremelyOutdated"] = "|cffff0000警告：|r 你的 Big Wigs 已经过期超过120个修订版本了！！此版本可能有许多臭虫（Bug）、功能缺失或完全不正确的计时器。“强烈”建议升级。"
L["finishedLoading"] = "战斗已结束，Big Wigs 已完成加载。"
L["FLASH"] = "闪烁"
L["FLASH_desc"] = "有些技能可能比其他的更重要。如果想这些重要技能施放时屏幕进行闪烁，选中此选项。"
L["flashScreen"] = "闪屏"
L["flashScreenDesc"] = "某些技能极其重要到需要充分被重视。当这些能力对你造成影响时 Big Wigs 可以使屏幕闪烁。"
L["flex"] = "弹性"
...
L["ircChannel"] = "#bigwigs 频道位于 irc.freenode.net"
L["kills"] = "击杀："
L["lfr"] = "随机团队"
L["license"] = "许可"
...
L["mythic"] = "史诗"
L["newReleaseAvailable"] = "有新的 Big Wigs 正式版可用。（/bwv）你可以访问 curse.com，wowinterface.com，wowace.com 或使用 Curse 更新器来更新到新的正式版。"
L["noBossMod"] = "没有首领模块："
L["norm10"] = "10人"
L["norm25"] = "25人"
L["normal"] = "普通"
L["officialRelease"] = "你所使用的 Big Wigs %s 为官方正式版（修订号%d）"
L["oldVersionsInGroup"] = "在你队伍里使用旧版本或没有使用 Big Wigs。你可以用 /bwv 获得详细内容。"
L["outOfDate"] = "过期："
L["PROXIMITY"] = "近距离显示"
...
L["severelyOutdated"] = "|cffff0000你的 Big Wigs 已经过期超过300个修订版本了！*强烈建议*你更新，以防止与其他玩家发生同步冲突的问题！|r"
L["showBlizzWarnings"] = "暴雪警报"
L["showBlizzWarningsDesc"] = [=[暴雪提供了他们自己的警报信息。我们认为，这些信息太长和复杂。我们试着简化这些消息而不打扰游戏的乐趣，并不需要你做什么。
...
L["sourceCheckout"] = "你所使用的 Big Wigs %s 为从源直接检出的。"
L["stages"] = "阶段"
...
L["zoneMessagesDesc"] = "禁用此项 Big Wigs 在进入新区域时将停止显示已有计时器。建议不要关闭此选项，因为可能在进入新的区域时需要创建新的计时器，这是非常有帮助的。"
