...
L["blockMovies"] = "阻止首領過場動畫"
L["blockMoviesDesc"] = "在看過一次首領過場動畫以後，Big Wigs 將防止它再次播放。"
L["bosskill"] = "首領死亡"
...
L["ircChannel"] = "#wowace 頻道位於 irc.freenode.net"
L["kills"] = "擊殺："
L["lfr"] = "隨機團隊"
L["license"] = "許可"
...
L["modulesDisabled"] = "所有運行中的模組都已禁用。"
...
L["showBlizzWarnings"] = "暴雪警報"
L["showBlizzWarningsDesc"] = [=[暴雪提供了他們自己的警報訊息。我們認為，這些訊息太長和複雜。我們試著簡化這些消息而不打擾遊戲的樂趣，並不需要你做什麼。
