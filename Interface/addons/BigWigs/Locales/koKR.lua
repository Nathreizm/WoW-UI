...
L["extremelyOutdated"] = "|cffff0000경고:|r 당신의 Big Wigs가 120개 이상의 업데이트가 밀려있습니다.!! 이 버전에는 버그가 있거나, 없는 기능이 있거나, 타이머가 완전히 틀릴 수 있습니다. 업데이트를 강력하게 권장합니다."
...
L["ircChannel"] = "irc.freenode.net의 #bigwigs 채널"
L["kills"] = "죽임:"
L["lfr"] = "공격대 찾기"
L["license"] = "라이선스"
...
L["severelyOutdated"] = "|cffff0000현재 사용하시는 Big Wigs의 버전이 최신보다 300 이상 뒤쳐져있습니다! 다른 플레이어들과의 동기화와 관련하여 문제가 발생하는 것을 방지하기 위하여 업데이트를 할 것을 매우 권장해드립니다!|r"
L["showBlizzWarnings"] = "블리자드 경고 표시"
L["showBlizzWarningsDesc"] = [=[블리자드에서 보스에 대한 몇몇 중요 능력에 대하여 경고를 제공합니다. 이러한 메시지는 Big Wigs에서 보다 쉽게 따로 메시지를 제공하기에 블리자드 경고가 방해가 될수 있습니다. 
...
L["slashDescVersion"] = "|cFFFED000/bwv:|r Big Wigs의 버전을 확인합니다."
L["sound"] = "효과음"
L["soundDesc"] = [=[메시지와 함께 효과음을 사용합니다.

|cffff4411각 메세지에 대한 효과음이 있으며 그 효과음을 통하여 보다 효율적으로 메세지에 대하여 인지가 가능합니다.|r]=]
L["sourceCheckout"] = "저장소에서 Big Wigs %s의 소스 체크 아웃을 직접 실행하고 있습니다."
L["stages"] = "단계"
...
L["zoneMessagesDesc"] = "이 옵션을 끄면, Big Wigs 플러그인이 설치되지 않은 지역으로 진입할 때 메시지 표시를 중단합니다. 새 지역의 타이머가 갑자기 만들어질 경우에 알림을 받을 수 있는 유일한 옵션이기 때문에, 이 것을 켜두는 것을 권장합니다."
