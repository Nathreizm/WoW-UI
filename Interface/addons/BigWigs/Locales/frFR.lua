...
L["blockMovies"] = "Bloquer les cinématiques"
L["blockMoviesDesc"] = "Après avoir visionné une cinématique de boss une première fois, Big Wigs empêchera qu'elle soit jouée à nouveau."
...
L["extremelyOutdated"] = "|cffff0000ATTENTION :|r votre Big Wigs est périmé de plus de 120 révisions !! Votre version peut contenir des bogues, des fonctionnalités manquantes ou encore avoir des délais totalement faux. Il est FORTEMENT recommandé de mettre à jour."
...
L["introduction"] = "Bienvenue sur Big Wigs, votre compagnon des rencontres de boss. Attachez votre ceinture, gavez-vous de cacahouètes et profitez du voyage. Il ne fera pas de mal à vos enfants, mais vous aidera à préparer cette nouvelle rencontre de boss pour votre groupe de raid." -- Needs review
L["ircChannel"] = "irc.freenode.net sur le canal #wowace"
L["kills"] = "Victoires :"
L["lfr"] = "RdR"
L["license"] = "Licence"
...
L["newReleaseAvailable"] = "Une nouvelle version de Big Wigs est disponible (/bwv). Vous pouvez visiter curse.com, wowinterface.com, wowace.com ou utiliser le Curse Updater pour obtenir cette nouvelle version."
...
L["warmup_desc"] = "Temps avant que le combat face au boss ne commence." -- Needs review
L["website"] = "Site web"
L["wipes"] = "Échecs :"
