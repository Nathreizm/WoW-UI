...
L["allRightsReserved"] = "Alle Rechte vorbehalten"
...
L["blizzRestrictionsZone"] = "Warte bis zum Ende des Kampfes um BigWigs vollständig zu Laden. (Blizzard Kampf-Einschränkungen)."
L["blockMovies"] = "Videos blockieren"
L["blockMoviesDesc"] = "Nachdem Sie eine Boss-Videosequenz einmal gesehen haben, wird diese zukünftig von BigWigs blockiert."
...
L["configureBtnName"] = "Verschieben/Konfigurieren > Leisten/Nachrichten/..."
L["contact"] = "Kontakt"
...
L["extremelyOutdated"] = "|cffff0000WARNUNG:|r Dein Big Wigs ist seit mehr als 120 Revisionen veraltet!! Deine Version kann Fehler oder falsche Timer enthalten und es können Features fehlen. Ein Update wird STARK empfohlen."
L["finishedLoading"] = "Kampf ist vorbei, Big Wigs is nur vollständig geladen."
L["FLASH"] = "Aufleuchten"
...
L["flashScreenDesc"] = "Einige wichtige Fähigkeiten erfordern volle Aufmerksamkeit. Beim Auftreten dieser Fähigkeiten kann Big Wigs den Bildschirm aufleuchten lassen."
L["flex"] = "Flexibel"
...
L["minimapIcon"] = "Minimap Symbol"
L["minimapToggle"] = "Zeigt oder versteckt das Minimap Symbol."
...
L["newReleaseAvailable"] = "Eine neue Version von Big Wigs ist verfügbar (/bwv). Du kannst curse.com, wowinterface.com, wowace.com besuchen oder den Curse Client benutzen, um den Release zu bekommen."
L["noBossMod"] = "Kein Boss-Mod:"
L["norm10"] = "10"
L["norm25"] = "25"
L["officialRelease"] = "Bei dir läuft ein offizieller Release von Big Wigs %s (revision %d)."
L["oldVersionsInGroup"] = "Es gibt Leute in deiner Gruppe mit veralteten Versionen oder ohne Big Wigs. Mehr Details mit /bwv."
...
L["raidIcons"] = "Schlachtzugs-Symbole"
L["raidIconsDesc"] = [=[Einige Bossmodule benutzen Schlachtzugs-Symbole, um Spieler zu markieren, die von speziellem Interesse für deine Gruppe sind. Beispiele wären 'Bomben'-Effekte und Gedankenkontrolle. Wenn du diese Option ausschaltest, markierst du niemanden mehr.
...
L["sourceCheckout"] = "Bei dir läuft ein Source Code Checkout von Big Wigs %s direkt aus dem Repository."
L["stages"] = "Phasen"
