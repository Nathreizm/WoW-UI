...
L["big_add"] = "Gros add" -- Needs review
L["cast"] = "<%s incanté>"
...
L["focus_only"] = "|cffff0000Alertes de la cible de focalisation uniquement.|r " -- Needs review
L["general"] = "Général"
...
L["removed"] = "%s enlevé"
L["say"] = "%s sur MOI !"
L["small_adds"] = "Petits adds" -- Needs review
L["soon"] = "%s imminent(e) !"
L["spawning"] = "Apparition |2 %s !" -- Needs review
L["stack"] = "%dx %s sur %s"
L["stage"] = "Phase %d"
