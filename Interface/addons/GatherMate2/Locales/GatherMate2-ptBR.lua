...
L["Cleanup Failed."] = "Limpeza falhou" -- Needs review
L["Cleanup in progress."] = "Limpeza em progresso" -- Needs review
...
L["Cleanup Started."] = "Limpeza iniciada" -- Needs review
...
NL["Mantid Archaeology Find"] = "Descoberta Arqueológica Mantídea" -- Needs review
