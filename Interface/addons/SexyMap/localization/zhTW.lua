...
L["Quickly change the look of your minimap by using a minimap preset."] = "快速改變你的小地圖外觀藉由使用預設的設定。"
...
L["User-Submitted Presets"] = "使用者提交設定檔"
...
L["Video Recording Button (Mac OSX Only, When Available)"] = "聲音紀錄按鈕(只有Mac OSX，當啟用時)"
L["Visibility"] = "能見度"
