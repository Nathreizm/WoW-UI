...
Postal3DB = {
	...
	["profiles"] = {
		["Boomflower - Rexxar"] = {
			["BlackBook"] = {
				["recent"] = {
					"Littleboytoy|Rexxar|Horde", -- [1]
					"Mithrios|Rexxar|Horde", -- [2]
				},
			},
		},
		["Arrier - Alexstrasza"] = {
		...
		["Nathreizm - Rexxar"] = {
			["BlackBook"] = {
				["recent"] = {
					"Failangel|Rexxar|Horde", -- [1]
					"Mithrios|Rexxar|Horde", -- [2]
					"Mõlishüs|Rexxar|Horde", -- [3]
					"Üsexÿbeast|Rexxar|Horde", -- [4]
					"Audrigale|Rexxar|Horde", -- [5]
					"Aranda|Rexxar|Horde", -- [6]
					"Mayamoamor|Rexxar|Horde", -- [7]
					"Mizzrym|Rexxar|Horde", -- [8]
					"Chadbutler|Rexxar|Horde", -- [9]
					"Mõpaldurdin|Rexxar|Horde", -- [10]
					"Andromedia|Rexxar|Horde", -- [11]
					"Lildar|Rexxar|Horde", -- [12]
					"Mik|Rexxar|Horde", -- [13]
				},
			},
		},
		...
		["Littleboytoy - Cho'gall"] = {
			["BlackBook"] = {
				["recent"] = {
					"Nathreizm|Cho'gall|Horde", -- [1]
					"Demheals|Cho'gall|Horde", -- [2]
					"Mortera|Cho'gall|Horde", -- [3]
				},
			},
		},
		["Mithrios - Rexxar"] = {
